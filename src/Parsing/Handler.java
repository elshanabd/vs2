    ...
    //}
            if (creditSay==g&&qName.contentEquals("CreditInfo"))
            {
                ...
                JOptionPane.showMessageDialog(null, 
                        ...
                        "] \n"+
                        "Result : ["+g+"]  sayda kredit melumati emal olundu",
                        "Faylin emali basha catdi" , JOptionPane.INFORMATION_MESSAGE);
               try {
                   otf.setFileName("");
      ...
      if(qName.contentEquals("Credit")){
          ...
          if(objCDetails.getAccountNo().trim().contentEquals(account)){
              System.out.println("Object Account _no "+objCDetails.getAccountNo().trim()+" , Sent Account_no"+account);
               try {
